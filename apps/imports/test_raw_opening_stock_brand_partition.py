...
from apps.imports.services.raw_opening_stock_brand_partition import (
    partition_raw_opening_stock_rows_by_brand,
)


class RawOpeningStockBrandPartitionTests(TestCase):
    def setUp(self):
    ...
    def test_partitions_rows_by_truck_distribution_brand(self):
        ...
        result = partition_raw_opening_stock_rows_by_brand(
            rows
        )
