...
class RawPosImportReviewError(Exception):
    def __init__(
        self,
        code: str,
        message: str,
...
class RawPosReviewResult:
    adapted: RawPosFileResult
